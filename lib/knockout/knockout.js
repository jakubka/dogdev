        ...
        (function(q) {
            "function" === typeof require && "object" === typeof exports && "object" === typeof module ? q(module.exports || exports) : "function" === typeof define && define.amd ? define(["exports"], q) : q(w.ko = {})
                ...
                a.a = function() {
                    ...
                    b(d, function(a, b) {
                        if (b.length)
                            for (var e = 0, c = b.length; e < c; e++) f[b[e]] = a
                    });
                    var g = {
                        propertychange: !0
                    }, e = s && function() {
                    ...
                    return {
                        ...
                        R: function(a, b) {
                            if (b instanceof Array) a.push.apply(a, b);
                                ...
                                for (var e = 0, c = b.length; e < c; e++) a.push(b[e]);
                            return a
                        },
                        ja: function(b, e, c) {
                        ...
                        P: function(b, e) {
                            a.a.oa(b);
                            if (e)
                                for (var c = 0, d = e.length; c < d; c++) b.appendChild(e[c])
                        },
                        eb: function(b, e) {
                        ...
                        Ob: function(e, c, d) {
                            d = d || {};
                            var g = d.params || {}, f = d.includeFields || this.Ta,
                                p = e;
                ...
                a.a.C = new function() {
                    ...
                    function c(e) {
                        var d =
                            b(e, !1);
                        if (d)
                            for (var d = d.slice(0), f = 0; f < d.length; f++) d[f](e);
                        a.a.f.clear(e);
                        "function" == typeof t && "function" == typeof t.cleanData && t.cleanData([e]);
                        if (g[e.nodeType])
                            for (d = e.firstChild; e = d;) d = e.nextSibling, 8 === e.nodeType && c(e)
                    }
                    ...
                    a.a.fa = function(b, c) {
                        ...
                        if (null !== c && c !== q)
                            if ("string" != typeof c && (c = c.toString()), "undefined" != typeof t) t(b).html(c);
                                ...
                                for (var d = a.a.xa(c), f = 0; f < d.length; f++) b.appendChild(d[f])
                    }
                })();
                ...
                a.j = function(b, c, d) {
                    ...
                    var r = d.write,
                        z = d.disposeWhenNodeIsRemoved || d.$ || null,
                        D = d.disposeWhen || d.Qa || F(!1),
                        x = f,
                        v = [],
                        t = null;
                    c || (c = d.owner);
                ...
                a.g = function() {
                    ...
                    return {
                        ...
                        da: function(c) {
                            ...
                            for (var d = null, f, k = 0; k < e.length; k++) {
                                ...
                                if (null === d) switch (l) {
                                    ...
                                    l = e.substring(d, k + 1);
                                    c.push(l);
                                    var n = "@ko_token_" + (c.length - 1) + "@",
                                        e = e.substring(0, d) + n + e.substring(k + 1),
                                        k = k - (l.length - n.length),
                                        d = null
                                }
                            }
                            f = d = null;
                            ...
                            e = e.split(",");
                            d = 0;
                            for (k = e.length; d < k; d++) p = e[d], r = p.indexOf(":"), 0 < r && r < p.length - 1 ? (l = p.substring(r + 1), f.push({
                        ...
                        ea: function(b) {
                            var e = "string" === typeof b ? a.g.da(b) : b,
                                c = [];
                            b = [];
                                ...
                                if (d) {
                                    do
                                        if (1 === d.nodeType) {
                                            ...
                                            if (g = m)
                                                for (m = d.nextSibling, r = 0; r < g.length; r++) m ? e.insertBefore(g[r], m) : e.appendChild(g[r])
                    ...
                    a.a.extend(a.M.prototype, {
                        ...
                        parseBindingsString: function(b, c, d) {
                            try {
                                ...
                                if (!(f = this.Na[b])) {
                                    var g = this.Na,
                                        e, m = "with($context){with($data||{}){return{" + a.g.ea(b) + "}}}";
                ...
                (function() {
                    ...
                    function d(b, c, d, h) {
                        ...
                        a.j(function() {
                            var f = d && d instanceof a.A ? d : new a.A(a.a.c(d)),
                                x = f.$data;
                            !z && h && a.jb(b, f);
                ...
                a.d.checked = {
                    init: function(b, c, d) {
                        a.a.o(b, "click", function() {
                            ...
                            else if ("radio" == b.type && b.checked) f =
                                b.value;
                            else return;
                            var g = c(),
                                e = a.a.c(g);
                ...
                a.d.options = {
                    ...
                    update: function(b, c, d) {
                        ...
                        var e = 0 == b.length,
                            m = !e && b.multiple ? b.scrollTop : null;
                        c = a.a.c(c());
                        var h = d(),
                            k = h.optionsIncludeDestroyed,
                            l = {}, n, p;
                ...
                a.a.Pa = function() {
                    function a(b, d, f, g, e) {
                        var m = Math.min,
                            ...
                            s, v, w;
                        for (l = 0; l <= n; l++)
                            for (v = s, k.push(s = []), w = m(r, l + q), p = h(0, l - 1); p <= w; p++) s[p] = p ? l ? b[l - 1] === d[p - 1] ? v[p - 1] : m(v[p] || t, s[p - 1] || t) + 1 : p + 1 : l + 1;
                        m = [];
                        h = [];
                        q = [];
                        l = n;
                ...
                (function() {
                    ...
                    a.a.Aa = function(d, f, g, e, m) {
                        ...
                        f = f || [];
                        e = e || {};
                        var l = a.a.f.get(d, "setDomNodeChildrenFromArrayMapping_lastMappingResult") === q,
                            n = a.a.f.get(d, "setDomNodeChildrenFromArrayMapping_lastMappingResult") || [],
                            p = a.a.Z(n, function(a) {
                                return a.X
                            }),
                            r = a.a.Pa(p, f, e.dontLimitMoves),
                            t = [],
                            s = 0,
                            x = 0,
                            v = [],
