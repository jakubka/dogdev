/* build: `node build.js modules=ALL exclude=gestures` */ /*! Fabric.js Copyright 2008-2013, Printio (Juriy Zaytsev, Maxim Chernyak) */
var exports = exports || {}, fabric = fabric || {
        version: "1.3.0"
    };
exports.fabric = fabric, typeof document != "undefined" && typeof window != "undefined" ? (fabric.document = document, fabric.window = window) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.window = fabric.document.createWindow()), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = typeof Buffer != "undefined" && typeof window == "undefined";
var Cufon = function() {
    function r(e) {
...
Cufon.registerEngine("canvas", function() {
    ...
    function(t, n, r, i, u, a) {
        ...
        var H = _.style,
            B = D.style || {}, j = c.convert(l.height - p + v),
            F = Math.ceil(j),
            I = F / j;
...
function() {
    ...
    function l(e, t) {
        return c(t)[fabric.util.string.camelize(fabric.util.string.capitalize(e))]
    }
    ...
    function x(e, t, n, r) {
        var i = r[0],
            ...
            f = r[5],
            l = r[6],
            c = L(f, l, i, s, u, a, o, t, n);
        for (var h = 0; h < c.length; h++) {
            var p = A.apply(this, c[h]);
    ...
    function L(e, t, n, r, i, s, o, u, a) {
        ...
        var A = .5 * (b + E) - L * (S - w),
            O = .5 * (w + S) + L * (E - b),
            M = Math.atan2(w - O, b - A),
            _ = Math.atan2(S - O, E - A),
            D = _ - M;
...
function() {
    ...
    function p(e, t) {
        ...
        var n = e.target || (typeof e.srcElement != "unknown" ? e.srcElement : null),
            r = fabric.document.body || {
                scrollLeft: 0,
                scrollTop: 0
            }, i = fabric.document.documentElement,
            s = n,
            o = 0,
            u = 0,
            a;
...
function() {
    ...
    function a(e) {
        ...
        return t = i.documentElement, typeof e.getBoundingClientRect != "undefined" && (r = e.getBoundingClientRect()), i != null && i === i.window ? n = i : n = i.nodeType === 9 && (i.defaultView || i.parentWindow), {
            left: r.left + (n.pageXOffset || t.scrollLeft) - (t.clientLeft || 0) + s.left,
            top: r.top + (n.pageYOffset || t.scrollTop) - (t.clientTop || 0) + s.top
        }
    }
...
function() {
    function e(e) {
        ...
        var t = +(new Date),
            r = e.duration || 500,
            i = t + r,
            s, o = e.onChange || function() {}, u = e.abort || function() {
                return !1
            }, a = e.easing || function(e, t, n, r) {
...
function(e) {
    ...
    n(t, {
        parseAttributes: h,
        parseElements: g,
        parseStyleAttribute: v,
        parsePointsAttribute: p,
        getCSSRules: y,
        loadSVGFromURL: E,
        loadSVGFromString: x,
        createSVGFontFacesMarkup: T,
        createSVGRefElementsMarkup: N,
        getGradientDefs: C
    })
...
function() {
    ...
    function t(e, t) {
        for (var n in t) {
            ...
            if (n === "x1" || n === "x2") t[n] -= fabric.util.toFixed(e.width / 2, 2);
            else if (n === "y1" || n === "y2") t[n] -= fabric.util.toFixed(e.height / 2, 2)
        }
    }
    ...
    fabric.Gradient = fabric.util.createClass({
        ...
        toSVG: function(e, t) {
            var r = fabric.util.object.clone(this.coords),
                i;
        ...
        fromElement: function(n, r) {
            var i = n.getElementsByTagName("stop"),
                s = n.nodeName === "linearGradient" ? "linear" : "radial",
                o = n.getAttribute("gradientUnits") || "objectBoundingBox",
                u = [],
                a = {};
            s === "linear" ? a = {
            ...
            return t(r, a), new fabric.Gradient({
                type: s,
                coords: a,
                gradientUnits: o,
                colorStops: u
    ...
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        remove: function(e) {
            return this.getActiveObject() === e && (this.fire("before:selection:cleared", {
                target: e
            }), this.discardActiveObject(), this.fire("selection:cleared")), fabric.Collection.remove.call(this, e)
        },
...
function() {
    ...
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        _setupCurrentTransform: function(n, r) {
            if (!r) return;
            var i = "drag",
                s, o = e(n, r.canvas.upperCanvasEl);
            s = r._findTargetCorner(n, this._offset), s && (i = s === "ml" || s === "mr" ? "scaleX" : s === "mt" || s === "mb" ? "scaleY" : s === "mtr" ? "rotate" : "scale");
            var u = r.originX,
                a = r.originY;
            if (s === "ml" || s === "tl" || s === "bl") u = "right";
            else if (s === "mr" || s === "tr" || s === "br") u = "left";
            if (s === "tl" || s === "mt" || s === "tr") a = "bottom";
            else if (s === "bl" || s === "mb" || s === "br") a = "top";
        ...
        _handleGroupLogic: function(e, t) {
            ...
            var n = this.getActiveGroup();
            if (n) n.contains(t) ? (n.removeWithUpdate(t), this._resetObjectTransform(n), t.set("active", !1), n.size() === 1 && this.discardActiveGroup()) : (n.addWithUpdate(t), this._resetObjectTransform(n)), this.fire("selection:created", {
                target: n,
                e: e
            }), n.set("active", !0);
            else {
                if (this._activeObject && t !== this._activeObject) {
                    var r = this.getObjects(),
                        i = r.indexOf(this._activeObject) < r.indexOf(t),
                        s = new fabric.Group(i ? [t, this._activeObject] : [this._activeObject, t]);
                    this.setActiveGroup(s), this._activeObject = null, n = this.getActiveGroup(), this.fire("selection:created", {
                        target: n,
                        e: e
                    })
                }
        ...
        _scaleObject: function(e, t, n) {
            var r = this._currentTransform,
                s = this._offset,
                o = r.target,
                u = o.get("lockScalingX"),
                a = o.get("lockScalingY");
            if (u && a) return;
            var f = o.translateToOriginPoint(o.getCenterPoint(), r.originX, r.originY),
                l = o.toLocalPoint(new fabric.Point(e - s.left, t - s.top), r.originX, r.originY);
            r.originX === "right" ? l.x *= -1 : r.originX === "center" && (l.x *= r.mouseXSign * 2, l.x < 0 && (r.mouseXSign = -r.mouseXSign)), r.originY === "bottom" ? l.y *= -1 : r.originY === "center" && (l.y *= r.mouseYSign * 2, l.y < 0 && (r.mouseYSign = -r.mouseYSign)), i(l.x) > o.padding ? l.x < 0 ? l.x += o.padding : l.x -= o.padding : l.x = 0, i(l.y) > o.padding ? l.y < 0 ? l.y += o.padding : l.y -= o.padding : l.y = 0;
            var c = o.scaleX,
                h = o.scaleY;
            if (n === "equally" && !u && !a) {
                var p = l.y + l.x,
                    d = (o.height + o.strokeWidth) * r.original.scaleY + (o.width + o.strokeWidth) * r.original.scaleX;
        ...
        _drawSelection: function() {
            var e = this.contextTop,
                ...
                s = i(n),
                o = i(r);
            e.fillStyle = this.selectionColor, e.fillRect(t.ex - (n > 0 ? 0 : -n), t.ey - (r > 0 ? 0 : -r), s, o), e.lineWidth = this.selectionLineWidth, e.strokeStyle = this.selectionBorderColor;
            if (this.selectionDashArray.length > 1) {
                var a = t.ex + u - (n > 0 ? 0 : s),
                    f = t.ey + u - (r > 0 ? 0 : o);
                e.beginPath(), fabric.util.drawDashedLine(e, a, f, a + s, f, this.selectionDashArray), fabric.util.drawDashedLine(e, a, f + o - 1, a + s, f + o - 1, this.selectionDashArray), fabric.util.drawDashedLine(e, a, f, a, f + o, this.selectionDashArray), fabric.util.drawDashedLine(e, a + s - 1, f, a + s - 1, f + o, this.selectionDashArray), e.closePath(), e.stroke()
            } else e.strokeRect(t.ex + u - (n > 0 ? 0 : s), t.ey + u - (r > 0 ? 0 : o), s, o)
        },
        _findSelectedObjects: function(e) {
            var t = [],
                ...
                u = r + this._groupSelector.top,
                a, f = new fabric.Point(s(n, i), s(r, u)),
                l = new fabric.Point(o(n, i), o(r, u)),
                c = n === i && r === u;
            for (var h = this._objects.length; h--;) {
                a = this._objects[h];
                if (!a) continue;
                if (a.intersectsWithRect(f, l) || a.isContainedWithinRect(f, l) || a.containsPoint(f) || a.containsPoint(l))
                    if (this.selection && a.selectable) {
                        a.set("active", !0), t.push(a);
                        if (c) break
                    }
            }
            t.length === 1 ? this.setActiveObject(t[0], e) : t.length > 1 && (t = new fabric.Group(t.reverse()), this.setActiveGroup(t), t.saveCoords(), this.fire("selection:created", {
                target: t
            }), this.renderAll())
        },
        findTarget: function(e, t) {
            ...
            for (var o = this._objects.length; o--;)
                if (this._objects[o] && this._objects[o].visible && this._objects[o].selectable && this.containsPoint(e, this._objects[o])) {
        ...
        setActiveObject: function(e, t) {
            return this._activeObject && this._activeObject.set("active", !1), this._activeObject = e, e.set("active", !0), this.renderAll(), this.fire("object:selected", {
                target: e,
                e: t
            }), e.fire("selected", {
                e: t
        ...
        drawControls: function(e) {
            var t = this.getActiveGroup();
            if (t) e.save(), fabric.Group.prototype.transform.call(t, e), t.drawBorders(e).drawControls(e), e.restore();
            else
    ...
    for (var a in fabric.StaticCanvas) a !== "prototype" && (fabric.Canvas[a] = fabric.StaticCanvas[a]);
...
function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _onMouseDown: function(e) {
            this.__onMouseDown(e), !fabric.isTouchSupported && n(fabric.document, "mouseup", this._onMouseUp), fabric.isTouchSupported && n(fabric.document, "touchend", this._onMouseUp), !fabric.isTouchSupported && n(fabric.document, "mousemove", this._onMouseMove), fabric.isTouchSupported &&
                n(fabric.document, "touchmove", this._onMouseMove), !fabric.isTouchSupported && r(this.upperCanvasEl, "mousemove", this._onMouseMove), fabric.isTouchSupported && r(this.upperCanvasEl, "touchmove", this._onMouseMove)
        },
        ...
        _shouldRender: function(e, t) {
            ...
            return e && (e.isMoving || e !== n) || !e && n || t && this._previousPointer && this.selection && (t.x !== this._previousPointer.x || t.y !== this._previousPointer.y)
        },
        __onMouseUp: function(e) {
            ...
            if (this._currentTransform) {
                var i = this._currentTransform;
                t = i.target, t._scaling && (t._scaling = !1), t.setCoords(), this.stateful && t.hasStateChanged() && (this.fire("object:modified", {
                    target: t
                }), t.fire("modified"));
                if (this._previousOriginX && this._previousOriginY) {
                    var s = t.translateToOriginPoint(t.getCenterPoint(), this._previousOriginX, this._previousOriginY);
                    t.originX = this._previousOriginX, t.originY = this._previousOriginY, t.left = s.x, t.top = s.y, this._previousOriginX = null, this._previousOriginY = null
                }
            } else n = this.getPointer(e);
            r = this._shouldRender(t, n), this.selection && this._groupSelector && this._findSelectedObjects(e);
            var o = this.getActiveGroup();
            o && (o.setObjectsCoords(), o.isMoving = !1, this._setCursor(this.defaultCursor)), this._groupSelector = null, this._currentTransform = null, t && (t.isMoving = !1), r && this.renderAll(), this._setCursorFromEvent(e, t);
            var u = this;
            setTimeout(function() {
                u._setCursorFromEvent(e, t)
        ...
        _onMouseDownInDrawingMode: function(e) {
            this._isCurrentlyDrawing = !0, this.discardActiveObject().renderAll(), this.clipTo && fabric.util.clipContext(this, this.contextTop), this.freeDrawingBrush.onMouseDown(this.getPointer(e)), this.fire("mouse:down", {
                e: e
            })
        },
        __onMouseDown: function(e) {
            ...
            var n = this.findTarget(e),
                r = this.getPointer(e),
                i, s;
            this._previousPointer = r, s = this._shouldRender(n, r), this._shouldClearSelection(e, n) ? (this.selection && (this._groupSelector = {
                ex: r.x,
                ey: r.y,
                top: 0,
                left: 0
            }), this.deactivateAllWithDispatch(), n && n.selectable && this.setActiveObject(n, e)) : this._shouldHandleGroupLogic(e, n) ? (this._handleGroupLogic(e, n), n = this.getActiveGroup()) : (this.stateful && n.saveState(), (i = n._findTargetCorner(e, this._offset)) && this.onBeforeScaleRotate(n), n !== this.getActiveGroup() && n !== this.getActiveObject() && (this.deactivateAll(), this.setActiveObject(n, e)), this._setupCurrentTransform(e, n)), s && this.renderAll(), this.fire("mouse:down", {
                target: n,
                e: e
            }), n && n.fire("mousedown", {
                e: e
            }), i === "mtr" && n.centerTransform && this._setOriginToCenter(n)
        },
        ...
        __onMouseMove: function(e) {
            var t, n;
            if (this.isDrawingMode) {
                this._isCurrentlyDrawing && (n = this.getPointer(e), this.freeDrawingBrush.onMouseMove(n)), this.upperCanvasEl.style.cursor = this.freeDrawingCursor, this.fire("mouse:move", {
                    e: e
                });
                return
            }
            var r = this._groupSelector;
            if (r) n = i(e, this.upperCanvasEl), r.left = n.x - this._offset.left - r.ex, r.top = n.y - this._offset.top - r.ey, this.renderTop();
            else if (!this._currentTransform) {
                var s = this.upperCanvasEl.style;
                t = this.findTarget(e), !t || t && !t.selectable ? s.cursor = this.defaultCursor : this._setCursorFromEvent(e, t)
            } else {
                ...
                t = f.target, t.isMoving = !0, (f.action === "scale" || f.action === "scaleX" || f.action === "scaleY") && (e.altKey && (f.originX !== "center" || f.originY !== "center") || !e.altKey && f.originX === "center" && f.originY === "center") && (this._resetCurrentTransform(e), a = !0), f.action === "rotate" ? (this._rotateObject(o, u), this.fire("object:rotating", {
                    target: t,
                    e: e
                }), t.fire("rotating", {
                    e: e
                })) : f.action === "scale" ? ((e.shiftKey || this.uniScaleTransform) && !t.get("lockUniScaling") ? (f.currentAction = "scale", this._scaleObject(o, u)) : (!a && f.currentAction === "scale" && this._resetCurrentTransform(e), f.currentAction = "scaleEqually", this._scaleObject(o, u, "equally")), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
                })) : f.action === "scaleX" ? (this._scaleObject(o, u, "x"), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
                })) : f.action === "scaleY" ? (this._scaleObject(o, u, "y"), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
                })) : (this._translateObject(o, u), this.fire("object:moving", {
                    target: t,
                    e: e
                }), t.fire("moving", {
                    e: e
                }), this._setCursor(this.moveCursor)), this.renderAll()
            }
        ...
        _setCursorFromEvent: function(n, r) {
            ...
            var s = this.getActiveGroup(),
                o = r._findTargetCorner && (!s || !s.contains(r)) && r._findTargetCorner(n, this._offset);
            if (!o) i.cursor = r.hoverCursor || this.hoverCursor;
            else if (o in t) {
    ...
    __toDataURLWithMultiplier: function(e, t, n, r) {
        ...
        this.setWidth(o).setHeight(u), l.scale(r, r), n.left && (n.left *= r), n.top && (n.top *= r), n.width && (n.width *= r), n.height && (n.height *= r), f ? this._tempRemoveBordersControlsFromGroup(f) : a && this.deactivateAll && this.deactivateAll(), this.width = i, this.height = s, this.renderAll(!0);
        var c = this.__toDataURL(e, t, n);
        return l.scale(1 / r, 1 / r), this.setWidth(i).setHeight(s), f ? this._restoreBordersControlsOnGroup(f) : a && this.setActiveObject && this.setActiveObject(a), this.contextTop && this.clearContext(this.contextTop), this.renderAll(), c
    },
    ...
    t.Object = t.util.createClass({
        ...
        getSvgTransform: function() {
            var e = this.getAngle(),
                ...
                i = t.Object.NUM_FRACTION_DIGITS,
                s = "translate(" + r(n.x, i) + " " + r(n.y, i) + ")",
                o = e !== 0 ? " rotate(" + r(e, i) + ")" : "",
                u = this.scaleX === 1 && this.scaleY === 1 ? "" : " scale(" + r(this.scaleX, i) + " " + r(this.scaleY, i) + ")",
        ...
        toDataURL: function(e) {
            ...
            this.set("active", !1), this.setPositionByOrigin(new t.Point(n.width / 2, n.height / 2), "center", "center"), i.add(this);
            var o = i.toDataURL(e);
            return this.set(s).setCoords(), i.dispose(), i = null, o
        },
        isType: function(e) {
            return this.type === e
        },
...
function(e) {
    ...
    t.Line = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            ...
            return e.push("<line ", 'x1="', this.get("x1"), '" y1="', this.get("y1"), '" x2="', this.get("x2"), '" y2="', this.get("y2"), '" style="', this.getSvgStyles(), '"/>'), e.join("")
        },
        complexity: function() {
            return 1
        }
...
function(e) {
    ...
    t.Circle = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            var e = this._createBaseSVGMarkup();
            return e.push("<circle ", 'cx="0" cy="0" ', 'r="', this.radius, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), e.join("")
        },
    ...
    t.Triangle = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            var e = this._createBaseSVGMarkup(),
                ...
                n = this.height / 2,
                r = [-t + " " + n, "0 " + -n, t + " " + n].join(",");
            return e.push("<polygon ", 'points="', r, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), e.join("")
        },
        complexity: function() {
            return 1
        }
...
function(e) {
    ...
    t.Ellipse = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            var e = this._createBaseSVGMarkup();
            return e.push("<ellipse ", 'rx="', this.get("rx"), '" ry="', this.get("ry"), '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), e.join("")
        },
        render: function(e, t) {
...
function(e) {
    ...
    r.push("rx", "ry"), t.Rect = t.util.createClass(t.Object, {
        stateProperties: r,
        type: "rect",
        rx: 0,
        ry: 0,
        ...
        _render: function(e) {
            var t = this.rx || 0,
                ...
                s = this.width,
                o = this.height,
                u = this.group && this.group.type !== "group";
        ...
        toSVG: function() {
            var e = this._createBaseSVGMarkup();
            return e.push("<rect ", 'x="', -1 * this.width / 2, '" y="', -1 * this.height / 2, '" rx="', this.get("rx"), '" ry="', this.get("ry"), '" width="', this.width, '" height="', this.height, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), e.join("")
        },
        complexity: function() {
            return 1
        }
...
function(e) {
    ...
    t.Polyline = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            ...
            return t.push("<polyline ", 'points="', e.join(""), '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), t.join("")
        },
        _render: function(e) {
            var t;
        ...
        var i = t.parsePointsAttribute(e.getAttribute("points")),
            s = t.parseAttributes(e, t.Polyline.ATTRIBUTE_NAMES),
            o = r(i, "x"),
            u = r(i, "y");
        o = o < 0 ? o : 0, u = o < 0 ? u : 0;
...
function(e) {
    ...
    t.Polygon = t.util.createClass(t.Object, {
        ...
        toSVG: function() {
            ...
            return t.push("<polygon ", 'points="', e.join(""), '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'), t.join("")
        },
        _render: function(e) {
            var t;
            e.beginPath(), e.moveTo(this.points[0].x, this.points[0].y);
        ...
        if (!e) return null;
        i || (i = {});
        var s = t.parsePointsAttribute(e.getAttribute("points")),
...
function(e) {
    ...
    n.Path = n.util.createClass(n.Object, {
        ...
        toSVG: function() {
            ...
            var i = e.join(" ");
            return t.push('<g transform="', this.group ? "" : this.getSvgTransform(), '">', "<path ", 'd="', i, '" style="', this.getSvgStyles(), '" transform="translate(', -this.width / 2, " ", -this.height / 2, ")", '" stroke-linecap="round" ', "/>", "</g>"), t.join("")
        },
        complexity: function() {
...
function(e) {
    ...
    t.PathGroup = t.util.createClass(t.Path, {
        ...
        toSVG: function() {
            var e = this.getObjects(),
                t = ["<g ", 'style="', this.getSvgStyles(), '" ', 'transform="', this.getSvgTransform(), '" ', ">"];
    ...
    t.Group = t.util.createClass(t.Object, t.Collection, {
        ...
        render: function(e, n) {
            ...
            for (var i = 0, s = this._objects.length; i < s; i++) {
                var o = this._objects[i],
                    u = o.borderScaleFactor,
                    a = o.hasRotatingPoint;
        ...
        _restoreObjectState: function(e) {
            var t = this.get("left"),
                ...
                i = Math.cos(r) * e.get("top") * this.get("scaleY") + Math.sin(r) * e.get("left") * this.get("scaleX"),
                s = -Math.sin(r) * e.get("top") * this.get("scaleY") + Math.cos(r) * e.get("left") * this.get("scaleX");
        ...
        toSVG: function() {
            var e = [];
            for (var t = 0, n = this._objects.length; t < n; t++) e.push(this._objects[t].toSVG());
...
function(e) {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {
        type: "image",
        initialize: function(e, t) {
            t || (t = {}), this.filters = [], this.callSuper("initialize", t), this._initElement(e), this._initConfig(t), t.filters && (this.filters = t.filters, this.applyFilters())
        },
        getElement: function() {
        ...
        render: function(e, t) {
            ...
            e.save();
            var n = this.transformMatrix,
                r = this.group && this.group.type !== "group";
        ...
        n.onload = function() {
            fabric.Image.prototype._initFilters.call(e, e, function(r) {
                ...
                t && t(i), n = n.onload = n.onerror = null
            })
        }, n.onerror = function() {
...
function(e) {
    ...
    t.Image.filters.Mask = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        var r = t.document.createElement("img"),
            i = e.mask.src;
        r.onload = function() {
            e.mask = new t.Image(r, e.mask), n && n(new t.Image.filters.Mask(e)), r = r.onload = r.onerror = null
        }, r.onerror = function() {
            t.log("Error loading " + r.src), n && n(null, !0), r = r.onload = r.onerror = null
        }, r.src = i
...
function(e) {
    ...
    t.Image.filters.Tint = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        applyTo: function(e) {
            ...
            var a = parseInt("0x" + u.substr(0, 2), 16),
...
function(e) {
    ...
    o.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "backgroundColor", "textBackgroundColor", "useNative", "path"), t.Text = t.util.createClass(t.Object, {
        ...
        _drawChars: function(e, t, n, r, i) {
            t[e](n, r, i)
        },
        _drawTextLine: function(e, t, n, r, i, s) {
            i -= this.fontSize / 4;
            if (this.textAlign !== "justify") {
                this._drawChars(e, t, n, r, i, s);
                return
            }
            ...
            if (u > o) {
                var a = n.split(/\s+/),
                    ...
                    h = l / c,
                    p = 0;
                for (var d = 0, v = a.length; d < v; d++) this._drawChars(e, t, a[d], r + p, i, s), p += t.measureText(a[d]).width + h
            } else this._drawChars(e, t, n, r, i, s)
        },
        ...
        _renderTextFill: function(e, t) {
            ...
            for (var r = 0, i = t.length; r < i; r++) {
                ...
                n += s, this._drawTextLine("fillText", e, t[r], this._getLeftOffset(), this._getTopOffset() + n, r)
            }
        },
        _renderTextStroke: function(e, t) {
            ...
            for (var r = 0, i = t.length; r < i; r++) {
                ...
                n += o, this._drawTextLine("strokeText", e, t[r], this._getLeftOffset(), this._getTopOffset() + n, r)
            }
        ...
        _renderTextDecoration: function(e, t) {
            ...
            var n = this._getTextHeight(e, t) / 2,
                r = this,
                s = this.fontSize / 4;
            this.textDecoration.indexOf("underline") > -1 && i(this.fontSize * this.lineHeight), this.textDecoration.indexOf("line-through") > -1 && i(this.fontSize * this.lineHeight - s), this.textDecoration.indexOf("overline") > -1 && i(s)
        },
        ...
        toSVG: function() {
            ...
            return r += this._fontAscent ? this._fontAscent / 5 * this.lineHeight : 0, ['<g transform="', this.getSvgTransform(), '">', s.textBgRects.join(""), "<text ", this.fontFamily ? 'font-family="' + this.fontFamily.replace(/"/g, "'") + '" ' : "", this.fontSize ? 'font-size="' + this.fontSize + '" ' : "", this.fontStyle ? 'font-style="' + this.fontStyle + '" ' : "", this.fontWeight ? 'font-weight="' + this.fontWeight + '" ' : "", this.textDecoration ? 'text-decoration="' + this.textDecoration + '" ' : "", 'style="', this.getSvgStyles(), '" ', 'transform="translate(', i(n, 2), " ", i(r, 2), ')">', o.join(""), s.textSpans.join(""), "</text>", "</g>"].join("")
        },
...
}(typeof exports != "undefined" ? exports : this), fabric.util.object.extend(fabric.Text.prototype, {
    _renderViaCufon: function(e) {
        ...
        this.transform(e), Cufon.replaceElement(n, {
            ...
            backgroundColor: this.backgroundColor,
            textBackgroundColor: this.textBackgroundColor
        }), this.width = t.width, this.height = t.height, this._totalLineHeight = t.totalLineHeight, this._fontAscent = t.fontAscent, this._boundaries = t.boundaries, n = null, this.setCoords()
    },
    _initDummyElementForCufon: function() {
        var e = fabric.document.createElement("pre"),
            t = fabric.document.createElement("div");
...
function() {
    ...
    fabric.util.loadImage = function(e, t, n) {
        ...
        e && (e instanceof Buffer || e.indexOf("data") === 0) ? (i.src = i._src = e, t && t.call(n, i)) : e && e.indexOf("http") !== 0 ? request_fs(e, r) : e && request(e, "binary", r)
